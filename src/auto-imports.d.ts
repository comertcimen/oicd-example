...
declare global {
  ...
  const Toaster: typeof import('./hooks/useNotifications')['Toaster']
  const createRef: typeof import('react')['createRef']
  const forwardRef: typeof import('react')['forwardRef']
  const lazy: typeof import('react')['lazy']
  const memo: typeof import('react')['memo']
  const openConfirmModal: typeof import('@mantine/modals')['openConfirmModal']
  ...
  const useAppearanceStore: typeof import('./store/appearanceStore')['useAppearanceStore']
  ...
  const usePanelStore: typeof import('./store/panelStore')['usePanelStore']
